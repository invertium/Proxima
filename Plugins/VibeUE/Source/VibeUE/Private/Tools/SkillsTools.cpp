 ...
 * three Agent-Skills bundled-content kinds beyond the index: runnable Code (scripts dir .pyx|.py),
 * additional reference docs (e.g. reference dir .md), and Resources (schemas, templates, data, examples).
 *
